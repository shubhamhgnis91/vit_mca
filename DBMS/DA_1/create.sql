...
ALTER TABLE PROFESSOR ADD CONSTRAINT PROFESSOR_DEPT_ID_FK FOREIGN KEY(DEPT_ID) REFERENCES DEPARTMENT(DEPT_ID) ON DELETE CASCADE INITIALLY DEFERRED;

ALTER TABLE DEPARTMENT ADD CONSTRAINT DEPARTMENT_PROF_ID_FK FOREIGN KEY(PROF_ID) REFERENCES PROFESSOR(PROF_ID) ON DELETE CASCADE INITIALLY DEFERRED;
